...
// import { AccountService,ProfileService } from "../../proxy";
...
export const saveMyProfile = createAsyncThunk(
    ...
    (data: any) => {
        return ProfileService?.putMyProfile({requestBody:data}).then((result: any) => {
            return result;
        });
    }
);
...
export const sendEmailVerifyProfile = createAsyncThunk(
    ...
    (data: any) => {
        return AccountService?.postSendEmailConfirmationToken({requestBody:data})
            .then((result: any) => {
                return result;
            });
    }
...
export const setProfilePicture = createAsyncThunk(
    ...
    (data: any) => {
        return AccountService?.postProfilePicture(data)
            .then((result: any) => {
...
export const setTwoFactorEnabled = createAsyncThunk(
    ...
    (data: any) => {
        return ProfileService?.postMyProfileSetTwoFactorEnabled(data?.enabled)
            .then((result: any) => {
                console.log("result", data);
                return result;
            });
