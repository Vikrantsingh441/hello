...
// import { PaymentRequestAdminService } from "../../proxy";

let PaymentRequestAdminService: any;

const module = await import("../../proxy");
if ("PaymentRequestAdminService" in module) {
  PaymentRequestAdminService = module.PaymentRequestAdminService;
}
