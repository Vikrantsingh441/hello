...
// import { AuditLogsService } from "../../proxy";
...
// export const fetchAuditLogsData = createAsyncThunk(
//     "audit/fetchAuditLogsData",
//     (data: any) => {
...
// export const fetchEntityChanges =createAsyncThunk(
//     "audit/fetchEntityChanges",
//     (  { auditLogId,
//         entityChangeType,
//         entityId,
//         entityTypeFullName,
...
//         maxResultCount,
//     }:any)=>{
//         return AuditLogsService?.getAuditLogsEntityChanges({
//             auditLogId,
//             entityChangeType,
//             entityId,
//             entityTypeFullName,
