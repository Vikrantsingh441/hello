...
// import { RoleService, UserService, OrganizationUnitService} from "../../proxy";
...
export const addOrganizationUnit = createAsyncThunk(
    ...
    (data: any) => {
        const result = OrganizationUnitService?.postOrganizationUnits({ requestBody: data });
        return result;
    }
);
export const editOrganizationUnit = createAsyncThunk(
    ...
    ({ id, dTo }: { id: any; dTo: any }) => {
        const result = OrganizationUnitService?.putOrganizationUnits({ id: id, requestBody: dTo });
        return result;
    }
);
...
export const deleteMemberOrganizationUnit = createAsyncThunk(
    ...
    ({ id, memberId }: { id: any, memberId: any }) => {
        const result = OrganizationUnitService?.deleteOrganizationUnitsMembers({ id: id, memberId: memberId });
        return result;
    }
);
export const editMemberOrganizationUnit = createAsyncThunk(
    ...
    ({ id, dTo }: { id: any; dTo: any }) => {
        const result = OrganizationUnitService?.putOrganizationUnitsMembers({ id: id, requestBody: dTo });
        return result;
    }
);
...
export const deleteRolesOrganizationUnit = createAsyncThunk(
    ...
    ({ id, roleId }: { id: any, roleId: any }) => {
        const result = OrganizationUnitService?.deleteOrganizationUnitsRoles({ id, roleId });
        return result;
    }
);
export const editRolesOrganizationUnit = createAsyncThunk(
    ...
    ({ id, dTo }: { id: any; dTo: any }) => {
        const result = OrganizationUnitService?.putOrganizationUnitsRoles({ id: id, requestBody: dTo });
        return result;
    }
);
export const FetchRoleListOrganizationUnit = createAsyncThunk(
    ...
    () => {
        return RoleService?.getRoles1({ filter: undefined, sorting: undefined, skipCount: 0, maxResultCount: 1000 }).then((result: any) => { return result.items; }
        );
    }
);
...
const OrganizationTreeSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(GetOrganizationUnitsAvailableUsers.rejected, (state, action) => {
            state.status = "error";
        ...
        builder.addCase(GetOrganizationUnitsAvailableRoles.rejected, (state, action) => {
            state.status = "error";
